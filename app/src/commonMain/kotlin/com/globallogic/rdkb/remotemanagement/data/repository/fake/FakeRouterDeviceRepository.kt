...
class FakeRouterDeviceRepository(
    private val connectedDevices: MutableMap<RouterDevice, List<ConnectedDevice>> = mutableMapOf(
    ...
    private val routerDeviceInfos: MutableMap<RouterDevice, RouterDeviceInfo> = mutableMapOf(
    ...
    override suspend fun removeRouterDevice(device: RouterDevice) {
        ...
        routerDeviceInfos.remove(device)
        if (device == selectedRouterDevice) selectedRouterDevice = RouterDevice.empty
    }
